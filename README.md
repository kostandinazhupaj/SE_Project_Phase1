...
·        Adding a transaction (income or expense) with valid details.
...
·        Adding a transaction with the maximum allowable amount.
·        Adding a transaction with the minimum allowable amount.
·        Adding a transaction with a future date.
·        Adding a transaction with a past date beyond a reasonable timeframe.
...
·        Adding a transaction with missing or incomplete information.
·        Adding a transaction with an invalid date format.
·        Adding a transaction with a non-numeric amount.
·        Adding a transaction with a category that doesn't exist.
